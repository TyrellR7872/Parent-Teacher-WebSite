...
RSpec.describe UserAccount, type: :model do
  describe "check attributes and methods" do
    it "should be able to create a UserAccount object which has correct methods" do
      ua = UserAccount.create!(password: "testpass", email: "testuser@test.com", accounttype: "Parent", name: "Tester Name", childname: "Test Child", childgrade: 5, homeaddress: "123 Test Street", admin: false)
