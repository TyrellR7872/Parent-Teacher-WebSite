Feature: Filter emails based on account attributes
  ...
  Background: the website already has existing accounts
    ...
    | password  | email                | accounttype| name            | childname       | childgrade| homeaddress |admin|
    | halitjaha  | lhalitjaha@colgate.edu |  teacher   | Lumbardh Halitjaha  | Little T        | 4         | 13 Oak Dr   |false|
    | jamila    | ajamil@colgate.edu   |  parent  | Asad Jamil    | Little Jimmy    | 10         | 10 Oak Dr   |false|
