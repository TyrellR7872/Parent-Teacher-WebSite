...
user_account_1 = UserAccount.create!(password: "testpass1", password_confirmation:"testpass1", email: "asad876@gmail.com", accounttype: "Parent", name: "Asad", homeaddress: "Drake Hall", created_at: DateTime.new(2018,6,6), updated_at: DateTime.new(2018,6,6))
user_account_2 = UserAccount.create!(password: "testpass2", password_confirmation:"testpass2",  email: "ajamil@colgate.edu", accounttype: "Teacher", name: "Archil", homeaddress: "123 Test Street", created_at: DateTime.new(2018,6,6), updated_at: DateTime.new(2018,6,6))
