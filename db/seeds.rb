...
admin_1 = UserAccount.create!(password: "password", password_confirmation:"password", email: "ecareyhay@gmail.com", accounttype: "Admin", name: "Carey Hay", admin: true)

admin_2 = UserAccount.create!(password: "password", password_confirmation:"password", email: "katheffley@yahoo.com", accounttype: "Admin", name: "Kathleen Catania", admin: true)
